...
# 시장구분: J=KRX(확정 종가) · NX=NXT · UN=통합. 반드시 J를 쓴다 — NXT는
# 애프터마켓(15:30~20:00)이 열려 있어 16:05엔 NX/UN이 미확정 시간외가를 주고,
# 그러면 KRX 60일 히스토리(J 기준)에 이어붙일 때 정합이 깨진다.
KIS_MARKET_DIV = os.environ.get("KIS_MARKET_DIV", "J")
